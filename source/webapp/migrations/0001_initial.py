    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='grade', serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='Учитель')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grades', to='webapp.school', verbose_name='Школа')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='webapp.grade', verbose_name='Класс')),
            ],
        ),
    ]
